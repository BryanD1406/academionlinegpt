  ...
  <x-slot name="content">
    ...
    @if ($this->enabled)
      ...
      @if ($showingRecoveryCodes)
        <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
          <p class="font-semibold">
            {{ __('Guarda estos códigos de recuperación en un gestor de contraseñas seguro. Pueden ser usados para recuperar acceso a tu cuenta si pierdes el dispositivo de autenticación de dos factores.') }}
          </p>
        </div>
